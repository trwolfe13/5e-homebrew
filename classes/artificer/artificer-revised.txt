...
- any common item from *Xanathar's Guide to Everything*

<div class="pageNumber auto"></div>
<div class='footnote'>CLASSES | ARTIFICER V1.1</div>
\page
...
|  2nd  |         +2        | Spellcasting, Tool Expertise, Wondrous Invention |        3       |       3      |  2  |  —  |  —  |  —  |  —  |
|  3rd  |         +2        | Artificer Specialist feature                     |        3       |       4      |  3  |  —  |  —  |  —  |  —  |
|  4th  |         +2        | Ability Score Improvement, Infuse Magic          |        3       |       5      |  3  |  —  |  —  |  —  |  —  |
|  5th  |         +3        | Superior Attunement, Wondrous Invention          |        3       |       6      |  4  |  2  |  —  |  —  |  —  |
|  6th  |         +3        | Mechanical Servant                               |        3       |       7      |  4  |  2  |  —  |  —  |  —  |
|  7th  |         +3        | —                                                |        4       |       8      |  4  |  3  |  —  |  —  |  —  |
|  8th  |         +3        | Ability Score Improvement                        |        4       |       9      |  4  |  3  |  —  |  —  |  —  |
|  9th  |         +4        | Artificer Specialist feature                     |        4       |      10      |  4  |  3  |  2  |  —  |  —  |
|  10th |         +4        | Wondrous Invention                               |        4       |      11      |  4  |  3  |  2  |  —  |  —  |
|  11th |         +4        | —                                                |        4       |      12      |  4  |  3  |  3  |  —  |  —  |
|  12th |         +4        | Ability Score Improvement                        |        4       |      13      |  4  |  3  |  3  |  —  |  —  |
|  13th |         +5        | —                                                |        4       |      14      |  4  |  3  |  3  |  1  |  —  |
|  14th |         +5        | Artificer Specialist feature                     |        4       |      15      |  4  |  3  |  3  |  1  |  —  |
|  15th |         +5        | Superior Attunement, Wondrous Invention          |        4       |      16      |  4  |  3  |  3  |  2  |  —  |
|  16th |         +5        | Ability Score Improvement                        |        4       |      17      |  4  |  3  |  3  |  2  |  —  |
|  17th |         +6        | Artificer Specialist feature                     |        4       |      18      |  4  |  3  |  3  |  3  |  1  |
|  18th |         +6        | Ability Score Improvement                        |        4       |      19      |  4  |  3  |  3  |  3  |  1  |
|  19th |         +6        | —                                                |        4       |      20      |  4  |  3  |  3  |  3  |  2  |
|  20th |         +6        | Soul of Artifice, Wondrous Invention             |        4       |      21      |  4  |  3  |  3  |  3  |  2  |
</div>


### Artificer Specialist
At 1st level, you choose the type of Artificer Specialist you are: Alchemist or Gunsmith, both of which are detailed at the end of the class description. Your choice grants you features at 1st level and again st 3rd, 9th, 14th and 17th level.
...
#### Cantrips
At 2nd level, you know three cantrips of your choice from the artificer spell list. You learn additional artificer cantrips of your choice at higher levels, as shown in the Cantrips Known column of the Artificer table.

#### Spellbook
At 2nd level, you have a spellbook containing three 1st-level artificer spells from the artificer spell list (which appears at the end of this document). Your spellbook is the repository of the artificer spells you know, except your cantrips, which are fixed in your mind.
...
You prepare the list of artificer spells that are available for you to cast. To do so, choose a number of artificer spells from your spellbook equal to your Intelligence modifier + half your artificer level, rounded down (minimum of one spell). The spells must be of a level for which you have spell slots.

For example, if you're a 5th-level artificer, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include five spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell *cure wounds*, you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn’t remove it from your list of prepared spells.

You can change your list of prepared spells when you finish a long rest. Preparing a new list of artificer spells requires time spent studying your spellbook and memorizing the incantations and gestures you must make to cast the spell: at least 1 minute per spell level for each spell on your list.
...
#### Ritual Casting
You can cast an artificer spell as a ritual if that spell has the ritual tag and you have the spell in your spellbook. You don’t need to have the spell prepared.
...
> 
> **Copying a Spell into the Book.** When you find an artificer spell of 1st level or higher, you can add it to your spellbook if it is of a spell level you can prepare and if you can spare the time to decipher and copy it.
> 
> Copying that spell into your spellbook involves reproducing the basic form of the spell, then deciphering the unique system of notation used by the wizard or artificer who wrote it. You must practice the spell until you understand the sounds or gestures required, then transcribe it into your spellbook using your own notation.
> 
...
> 
> If you lose your spellbook, you can use the same procedure to transcribe the spells that you have prepared into a new spellbook. Filling out the remainder of your spellbook requires you to find new spells to do so, as normal. For this reason, many artificers and wizards keep backup spellbooks in a safe place.
> 
> **The Book’s Appearance.** Your spellbook is a unique compilation of spells, with its own decorative flourishes and margin notes. It might be a plain, functional leather volume that you received as a gift from your mentor, a finely bound gilt-edged tome you found in an ancient library, or even a loose collection of notes scrounged together after you lost your previous spellbook in a mishap.
> 
> 
...
You complete another item of your choice when you reach certain level sin this class: 5th, 10th, 15th, and 20th level. The item you choose must be on the list for your current artificer level or a lower level.
...
Starting at 4th level, you gain the ability to channel your artificer spells into objects for later use. When you cast an artificer spell with a casting time of 1 action, you can increase its casting time to 1 minute. If you do so and hold a non-magical item throughout the casting, you expend a spell slot, but none of the spell’s effects occur. Instead, the spell transfers into that item for later use if the item doesn’t already contain a spell from this feature.
...
Select a Large or smaller beast with a challenge rating of 2 or less. The servant uses that beast’s game statistics but it can look however you like, as long as its form is appropriate for its statistics. It has the following modifications:
...
For each level you gain after 6th, your mechanical servant gains an additional hit die and increases its hit points accordingly.
...
At 1st level, you can prepare a number of alchemical formula to use in battle. To do so, choose a number of formulae equal to your proficiency bonus + 1.

You can change your list of prepared formulae when you finish a long rest. Preparing a new list of alchemical formulae requires time spent preparing ingredients: at least five minutes per formula.
...
If an Alchemical Formula option requires a ranged attack, its range is 30/60ft.
...
Alternately, the vial can be thrown at a specific creature. Make a ranged attack against the target. On a hit, the target takes 1d6 fire damage.
...
***Liquid Ice.*** As an action, you can reach into your Alchemist’s Satchel, pull out a vial of crystalline blue fluid, and hurl the vial at a creature, object, or surface within 30 feet of you (the vial and its contents disappear if you don’t hurl the vial by the end of the current turn). On impact, the vial detonates in a 5-foot radius. Any creature in that area must succeed on a Dexterity saving throw or take 1d8 cold damage and have its speed reduced by 10 feet. Water and other non-magical liquid caught in the blast are frozen solid.

Alternately, the vial can be thrown at a specific creature. Make a ranged attack against the target. On a hit, the target takes 1d8 cold damage and its speed is reduced by 10 feet.

This formula’s damage increases by 1d6 when you reach certain levels in this class: 5th level (2d8), 9th level (3d8), 14th level (4d8), 13th level (4d8), 17th level (5d8), and 20th level (6d8).

***Scrap Bomb.*** As an action, you can reach into your Alchemist’s Satchel, pull out a sphere of metal, and hurl the sphere at a creature, object, or surface within 30 feet of you (the sphere and its contents disappear if you don’t hurl the vial by the end of the current turn). On impact, the sphere detonates in a 5-foot radius. Any creature in that area must succeed on a Dexterity saving throw or take 1d6 piercing damage. 

Alternately, the sphere can be thrown at a specific creature. Make a ranged attack  against the target. On a hit, the target takes 1d6 piercing damage.
...
- Alchemist now starts with proficiency in *alchemist's supplies*.
- Added *liquid ice* and *scrap bomb* alchemical formulae.
- Changed alchemical formulae so they are prepared on a long rest.
- Added ability to switch between 5ft. radius and single target with alchemical fire.
- Ranged attacks can be made up to 60 ft., but have disadvantage after 30 ft.

### Version 1.0

- Upgraded from third to half caster, with expanded spell list.
- Alchemist's *Mechanical Servant* gets hit die.
- New *Wristpocket* cantrip.
- Revised *Wondrous Invention* item lists.
- Included common magic item in starting equipment.
